...
public class dynamite_album_pg {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//album pg of dynamite
		w1.findElement(By.xpath("/html/body/div/div/main/section/ul/li[4]/div/div/div/a")).click();
		Thread.sleep(2000);
		
		//to play dynamite video
